          ...
          <div className="container">
            <div className="inner-page__wrapper">
                  ...
                  <form className="gym-hall-form__form">
                      ...
                      <ul className="gym-hall-form__check-list">
                        <li className="gym-hall-form__check-list-item">
                          <div className="custom-toggle custom-toggle--checkbox">
                            <label>
                              <input type="checkbox" value="location-1" name="location" /><span className="custom-toggle__icon">
                    ...
                    <div className="gym-hall-form__block gym-hall-form__block--addition">
                      ...
                      <ul className="gym-hall-form__check-list">
                        <li className="gym-hall-form__check-list-item">
                          <div className="custom-toggle custom-toggle--checkbox">
                            <label>
                              <input type="checkbox" value="addition-1" name="addition" /><span className="custom-toggle__icon">
                                <svg width="9" height="6" aria-hidden="true">
                                  <use xlinkHref="#arrow-check"></use>
                          ...
                          <div className="custom-toggle custom-toggle--checkbox">
                            <label>
                              <input type="checkbox" value="addition-1" name="addition" /><span className="custom-toggle__icon">
                                <svg width="9" height="6" aria-hidden="true">
                                  <use xlinkHref="#arrow-check"></use>
                                </svg></span><span className="custom-toggle__label">Парковка</span>
                            </label>
                          </div>
                        </li>
                        <li className="gym-hall-form__check-list-item">
                    ...
                    <div className="gym-hall-form__block">
                      ...
                      <div className="custom-toggle custom-toggle--switch">
                        <label>
                          <input type="checkbox" value="status-1" name="status" /><span className="custom-toggle__icon">
                            <svg width="9" height="6" aria-hidden="true">
                              <use xlinkHref="#arrow-check"></use>
              ...
              <div className="gyms-catalog">
                <GymsList gyms={[]} isForCatalogPage />
              </div>
            </div>
          </div>
        </section>
