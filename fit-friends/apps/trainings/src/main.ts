...
const SERVICE_TITLE = 'The «Trainings» service';
const SERVICE_DESCRIPTION = 'Trainings service API';
...
async function bootstrap() {
  ...
  Logger.log(
    `🚀 Trainings application is running on: http://localhost:${port}/${GLOBAL_PREFIX}`
  );
}
